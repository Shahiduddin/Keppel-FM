      ...
      <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-xl p-0 align-items-center">
          <a class="site-logo site-title" href="<?php echo e(route('home')); ?>">
            <img src="<?php echo e(asset('assets/images/logoIcon/apple.png')); ?>" alt="<?php echo app('translator')->get('site-logo'); ?>">
            <div class="equalizer">
          ...
          <div class="collapse navbar-collapse mt-lg-0 mt-3" id="navbarSupportedContent">
            <ul class="navbar-nav main-menu ms-auto align-items-center">
              ...
              <li><a href="<?php echo e(route('events')); ?>"><?php echo app('translator')->get('Events'); ?></a></li>
              <li><a href="<?php echo e(route('jockey')); ?>"><?php echo app('translator')->get('Our Jockey'); ?></a></li>
  ...
  <!-- header-section end  -->
<?php /**PATH D:\Xampp\htdocs\keppelfm\core\resources\views/templates/basic/partials/navbar.blade.php ENDPATH**/ ?>