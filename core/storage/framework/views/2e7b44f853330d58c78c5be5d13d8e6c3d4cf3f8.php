    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6 text-center">
          <a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset('assets/images/logoIcon/apple.png')); ?>" alt="<?php echo app('translator')->get('image'); ?>"></a>
...
<!-- footer section end --><?php /**PATH F:\xampp\htdocs\castlab\Files\core\resources\views/templates/basic/partials/footer.blade.php ENDPATH**/ ?>