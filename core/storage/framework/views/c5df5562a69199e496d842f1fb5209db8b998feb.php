        ...
        <div class="col-lg-12">
            <div class="card b-radius--10 ">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $archives; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $archive): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td data-label="<?php echo app('translator')->get('User'); ?>">
                                            <div class="user">
                                                <div class="thumb"><img
                                                        src="<?php echo e(getImage('assets/images/rj_image/' . $archive->jockey_image)); ?>"
                                                        alt="<?php echo app('translator')->get('image'); ?>"></div>
                                            </div>
                                        </td>

                                        <td data-label="<?php echo app('translator')->get('Event_name'); ?>"><?php echo e(__($archive->event_name)); ?></td>
                                        <td data-label="<?php echo app('translator')->get('Event Day'); ?>"><?php echo e(__($archive->week_name)); ?></td>

                                        <td data-label="<?php echo app('translator')->get('Start_time'); ?>"><?php echo e(\Carbon\Carbon::parse($archive->start_time)->format('H:i a')); ?></td>
                                        <td data-label="<?php echo app('translator')->get('End_time'); ?>"><?php echo e(\Carbon\Carbon::parse($archive->end_time)->format('H:i a')); ?></td>
                                        <td data-label="<?php echo app('translator')->get('Status'); ?>"><?php echo e(($archive->url == null && $archive->input_file == null) ? 'Add url / File' : 'Added'); ?>

                                        </td>
                                        <td data-label="<?php echo app('translator')->get('Action'); ?>">

                                            <a href="<?php echo e(route('admin.event.archive.details', $archive->id)); ?>" class="icon-btn mr-1"
                                            ...
                                            title="Delete" data-original-title="Delete" data-event="<?php echo e($archive->id); ?>" data-url="<?php echo e(route('admin.archive.delete',$archive->id)); ?>">
                ...
                <div class="card-footer py-4">
                    <?php echo e($archives->links('admin.partials.paginate')); ?>
...
<?php $__env->startPush('breadcrumb-plugins'); ?>
    <form action="<?php echo e(route('admin.archive.event.search',request('search'))); ?>" method="GET" class="form-inline float-sm-right bg--white">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\keppelfm\core\resources\views/admin/event/archiveall.blade.php ENDPATH**/ ?>